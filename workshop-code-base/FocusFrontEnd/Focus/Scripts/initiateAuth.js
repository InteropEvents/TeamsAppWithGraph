...
microsoftTeams.getContext(function (context) {
    ...
    let queryParams = {
        ...
        scope: "https://graph.microsoft.com/User.Read openid Mail.Send Organization.Read.All Directory.Read.All Organization.ReadWrite.All Directory.AccessAsUser.All",
        redirect_uri: window.location.origin + "/WorkFlow/EndAuth",
        nonce: _guid(),
        state: state,
